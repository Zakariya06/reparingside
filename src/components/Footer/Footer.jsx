    ...
    <footer>
      <div className="container">
          ...
          <div className="col-lg-4">
            <div className="footerBarnd">
              <a className="navbar-brand" href="#">
                <span className="brandName"> Azhar Suhail </span> Equipment
                Repairing
              </a>
              <p className="mainText">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
                beatae illo omnis aperiam ratione dolores tempora autem quas
                odit provident?
              </p>
              ...
              >
                <FaEnvelope className="locationIcon" />{" "}
                <span>as.equiprepair@gmail.com</span>{" "}
              </a>
        ...
        <div className="copyright">
          <p className="mainText">
            Copyright &copy; 2024 All Rights Reserved by Azhar Suhail Equipment
            Repairing
          </p>
        </div>
      </div>
